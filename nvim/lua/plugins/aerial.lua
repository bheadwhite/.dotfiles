...
local function sort_with_priority(symbols)
  ...
  local function comparator(a, b)
    local a_priority = lua_utils.matches_any(a.name, priority_keywords) and 1 or (lua_utils.matches_any(a.name, less_priority_keywords) and 3 or 2)
    local b_priority = lua_utils.matches_any(b.name, priority_keywords) and 1 or (lua_utils.matches_any(b.name, less_priority_keywords) and 3 or 2)
